...
- 22 unittest tests passed locally under Python 3.12.14.
- GitHub Actions passed on Python 3.10, 3.12 and 3.13: [verification run](https://github.com/pedronavarro-labs/agentreplay/actions/runs/35440989373).
...
No real model evaluation or independent MCP client interoperability check has occurred.
This is a development alpha, not a production security guarantee.

## Distribution

Source repository: https://github.com/pedronavarro-labs/agentreplay
